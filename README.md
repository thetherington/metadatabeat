...
`${GOPATH}/src/github.com/thetherington/metadatabeat`
...
```
git remote set-url origin https://github.com/thetherington/metadatabeat
...
in the same directory with the name metadatabeat.
...
```
./metadatabeat -c metadatabeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/thetherington/metadatabeat
git clone https://github.com/thetherington/metadatabeat ${GOPATH}/src/github.com/thetherington/metadatabeat
```
